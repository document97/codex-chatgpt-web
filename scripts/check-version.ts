...
// READMEs are documentation, not release machinery: upstream's rule that every
// localized README must embed exact versioned download URLs does not apply to this fork.

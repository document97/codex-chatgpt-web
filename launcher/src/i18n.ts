...
const en = {
  ...
  devConnectorIsolationNotice: "Reuse the existing Codex Native2 connector shown below. ChatGPT does not need to rename it or create a DEV-suffixed duplicate.",
  ...
  resetBrowserSession: "Clear browser data and sign in again",
  resetBrowserSessionBody: "Clear ChatGPT cookies, storage, HTTP cache, and code cache now, then open the sign-in page.",
  browserSessionReset: "Browser data cleared; sign in to ChatGPT again",
...
const zh: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "继续使用下方现有的 Codex Native2 连接器；无需在 ChatGPT 中改名，也无需另建带 DEV 后缀的连接器。",
  ...
  diagnostics: "诊断",
  runDoctor: "运行诊断",
  resetBrowserSession: "清理浏览器数据并重新登录",
  resetBrowserSessionBody: "立即清除 ChatGPT Cookie、存储、HTTP 缓存和代码缓存，然后打开登录页面。",
  browserSessionReset: "浏览器数据已清理；请重新登录 ChatGPT",
...
const ja: Record<keyof typeof en, string> = {
  ...
  devConnectorIsolationNotice: "下記の既存 Codex Native2 コネクタをそのまま使用します。ChatGPT 側で名前を変更したり、DEV 接尾辞付きの複製を作成したりする必要はありません。",
  ...
  diagnostics: "診断",
  runDoctor: "診断を実行",
  resetBrowserSession: "ブラウザーデータを消去して再ログイン",
  resetBrowserSessionBody: "ChatGPT の Cookie、ストレージ、HTTP キャッシュ、コードキャッシュを今すぐ消去し、ログインページを開きます。",
  browserSessionReset: "ブラウザーデータを消去しました。ChatGPT に再ログインしてください",
...
const ko: Record<keyof typeof en, string> = {
  ...
  supportBody: "더 많은 개발자가 Codex Web GPT를 찾을 수 있도록 저장소에 Star를 누르고 제 X 프로필을 열어주세요.",
  star: "GitHub에서 Star",
  starred: "GitHub 열림",
  follow: "X 열기",
  followed: "X 열림",
  ...
  diagnostics: "진단",
  runDoctor: "진단 실행",
  resetBrowserSession: "브라우저 데이터를 지우고 다시 로그인",
  resetBrowserSessionBody: "ChatGPT 쿠키, 저장소, HTTP 캐시와 코드 캐시를 지운 다음 로그인 페이지를 엽니다.",
  browserSessionReset: "브라우저 데이터를 지웠습니다. ChatGPT에 다시 로그인하세요",
...
const zhTW: Record<keyof typeof en, string> = {
  ...
  continue: "繼續",
  supportTitle: "開始之前",
  supportBody: "請為儲存庫按 Star，並開啟我的 X 主頁，幫助更多開發者發現 Codex Web GPT。",
  ...
  diagnostics: "診斷",
  runDoctor: "執行診斷",
  resetBrowserSession: "清除瀏覽器資料並重新登入",
  resetBrowserSessionBody: "立即清除 ChatGPT Cookie、儲存空間、HTTP 快取與程式碼快取，然後開啟登入頁面。",
  browserSessionReset: "瀏覽器資料已清除；請重新登入 ChatGPT",
